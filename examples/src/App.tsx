...
import {
  Hierarchy,
  HIERARCHY_ROUTE as HIERARCHY_PATH,
} from "./pages/Hierarchy";
import {
  AUTO_WAITING_ROUTE as AUTO_WAITING_PATH,
  AutoWaiting,
} from "./pages/AutoWaiting";
import {
...
import {
  Transform,
  TRANSFORM_ROUTE as TRANSFORM_PATH,
...
import {
  NAME_AND_TYPE_ROUTE as NAME_AND_TYPE_PATH,
  NameAndType,
} from "./pages/NameAndType";
